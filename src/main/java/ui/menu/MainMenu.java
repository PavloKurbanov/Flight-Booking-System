...
public class MainMenu {
    ...
    public MainMenu(InputOutput inputOutput, FlightService flightService, PassengerService passengerService, TicketService ticketService, TicketViewService ticketViewService) {
        this.inputOutput = inputOutput;
        MainMenuBuilder mainMenuBuilder = new MainMenuBuilder(inputOutput, flightService, passengerService, ticketService, ticketViewService);
